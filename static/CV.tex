...
\begin{longtable}{p{0.1\linewidth} P{0.85\linewidth}}
%2018--2022 & PostDoc research project (DAAD MOPGA-GRI) at the Museum f\"{u}r Naturkunde (MfN) with G. Asatryan on `Polar Oceans, Phytoplankton and Oceanic Carbon Sequestration in a Warm, High $p_{CO_2}$ World'.\\
...
\subsection{Grants}
\begin{longtable}{p{0.1\linewidth} P{0.85\linewidth}}
% 2018 & DAAD `Make Our Planet Great Again -- German research Initiative' grant, as co-PI (PI: Gayane Asatryan).\\
...
%08/2018--07/2022 & Postdoctoral researcher (DAAD MOPGA-GRI) at the MfN.\\
