...
\begin{longtable}{p{0.1\linewidth} P{0.85\linewidth}}
2019 & Piazza V., Duarte L.V., Renaudie J., Aberhan M. \href{http://doi.org/10.1017/pab.2019.11}{Reductions in body size of benthic macro- invertebrates as a precursor of the Early Toarcian (Early Jurassic) extinction event in the Lusitanian Basin, Portugal}. \textit{Paleobiology}.\\
...
%  & Varela S., Sbrocco E.J., Tarroso P., Perez-Luque A.J., Renaudie J., Warnst\"{a}dt N., Fandos G., Foster W.J., Tietje M. \href{https://www.revistaecosistemas.net/index.php/ecosistemas/article/view/n}{BioExtreme hackathon en el Museum f\"{u}r Naturkunde de Berlín, Alemania.} \textit{Ecosistemas}, 28(1).\\
%\end{longtable}
...
\end{longtable}
\subsection[Posters]{Posters \textnormal{(last 3 years only)}}
\begin{longtable}{p{0.1\linewidth} P{0.85\linewidth}}
...
\section[MEDIA COVERAGE]{MEDIA COVERAGE \textnormal{of projects I'm involved with (selection)}}
\begin{longtable}{p{0.1\linewidth} P{0.85\linewidth}}
2019 & \href{http://dx.doi.org/10.1126/science.aax7040}{Newly drilled sediment cores could reveal how fast the Antarctic ice sheet will melt}, \emph{Science}. April, 15th. [Expedition 379]\\
