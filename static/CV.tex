...
% \begin{longtable}{p{0.1\linewidth} P{0.85\linewidth}}
% & Lazarus D.B., Gray R., Renaudie J. Neural net classification of unedited transmitted light microscope images of radiolaria from a sparse dataset. \textit{Submitted to PeerJ}.\\
% \end{longtable}
