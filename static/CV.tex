...
\begin{longtable}{p{0.1\linewidth} P{0.85\linewidth}}
% 2021 %& Buchwitz M., Jansen M., Renaudie J., Voigt S. Evolutionary shift in locomotion close to the origin of amniotes inferred in a phylogenetically informed analysis of trackway data.\\
...
\begin{longtable}{p{0.1\linewidth} P{0.85\linewidth}}
2020 & Wissenschaftstag `Lighthouse Projects' (MfN): Automatic species counting for biodiversity and climate change research using AI and massive collection imaging. September, 21st.\\
