...
2018 & Renaudie J., Gray R., Lazarus D.B. \href{https://peerj.com/preprints/27328/}{Accuracy of a neural net classification of closely-related species of microfossils from a sparse dataset of unedited images.} \textit{Submitted to PeerJ}.\\
 & Piazza V., Duarte L., Renaudie J., Aberhan A. Reductions in body size of benthic macro- invertebrates as a precursor of the Early Toarcian (Early Jurassic) extinction event in the Lusitanian Basin, Portugal. \textit{Submitted to Paleobiology}.\\
\end{longtable}

% \section{FIELDWORK}
% \begin{longtable}{p{0.1\linewidth} P{0.85\linewidth}}
% 2019 & \href{https://iodp.tamu.edu/scienceops/expeditions/amundsen_sea_ice_sheet_history.html}{IODP Expedition 379 to the Amundsen Sea}: Paleontology (radiolarians).\\
% \end{longtable}
...
%\begin{longtable}{p{0.1\linewidth} P{0.85\linewidth}}
%2019 & EGU general meeting in Vienna, Austria: convener of the session \href{https://meetingorganizer.copernicus.org/EGU2019/session/31040}{`SSP4.5/BG3.25/CL4.38.2 Evolutionary development of plankton and its interaction with past, present and future geochemical cycles'} (co-conveners: Noble P., Lazarus D., Asatryan G. and Schobben M.).\\
%\end{longtable}
\subsection{Talks}
\begin{longtable}{p{0.1\linewidth} P{0.85\linewidth}}
...
% \begin{longtable}{p{0.1\linewidth} P{0.85\linewidth}}
% 2019 & EGU General meeting in Vienna, Austria: Renaudie J., Diver P., Lazarus D. B., Big Data in micropaleontology: recent developments in the Neptune (NSB) database and related tools.\\
% \end{longtable}
...
since 2013 & \href{http://publons.com/a/1291154/}{Reviews} for \textit{Proceedings of the Royal Society B}; \textit{Paleoceanography}; \textit{Paleobiology}; \textit{Palaeogeography, Palaeoclimatology, Palaeoecology}; \textit{Journal of Plankton Research}. \\
\end{longtable}
