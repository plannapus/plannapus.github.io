...
\begin{longtable}{p{0.1\linewidth} P{0.85\linewidth}}
%2018--22 & PostDoc research project (DAAD MOPGA-GRI) at the Museum f\"{u}r Naturkunde (MfN) with G. Asatryan on `Polar Oceans, Phytoplankton and Oceanic Carbon Sequestration in a Warm, High $p_{CO_2}$ World'.\\
...
\begin{longtable}{p{0.1\linewidth} P{0.85\linewidth}}
% 2018 & Geo-X `Introduction to Earth-System Climate Modelling' workshop with GENIE at MfN. \\
