...
\end{longtable}
\subsection[Talks]{Talks \textnormal{\footnotesize{(\underline{speaker}; last 5 only)}}}
\begin{longtable}{@{}p{0.1\linewidth} P{0.85\linewidth}@{}}
...
\end{longtable}
\subsection[Posters]{Posters \textnormal{\footnotesize{(\underline{presenting}; last 5 only)}}}
\begin{longtable}{@{}p{0.1\linewidth} P{0.85\linewidth}@{}}
...
\begin{longtable}{@{}p{0.1\linewidth} P{0.85\linewidth}@{}}
%2021 & Scientific board member for INTERRAD meeting.
...
\begin{longtable}{@{}p{0.1\linewidth} P{0.85\linewidth}@{}}
%2021 & %\href{}{Interactive display} for the ``Biominerale -- das Geheimnis der Schale'' exhibition at the Museum f\"{u}r Naturkunde Magdeburg, Germany.\\
