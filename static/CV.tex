...
% \begin{longtable}{p{0.1\linewidth} P{0.85\linewidth}}
% 2018 & Renaudie J., Gray R., Lazarus D. \href{}{Accuracy of a neural net classification of closely-related species of microfossils from a sparse dataset of unedited images.} \textit{Submitted to PeerJ}.\\
% & Piazza V., Duarte L., Renaudie J., Aberhan A. Reductions in body size of benthic macroinvertebrates as a precursor of the Early Toarcian (Early Jurassic) extinction event in the Lusitanian Basin, Portugal. \textit{Submitted to Paleobiology}.\\
% \end{longtable}
...
\subsection{Posters}
\begin{longtable}{p{0.1\linewidth} P{0.85\linewidth}}
% 2018 & TMS Annual meeting in Leeds, UK: Asatryan G., Lazarus D., Renaudie J., Paleogene polar phytoplankton and oceanic carbon sequestration; Renaudie J., Drews E.-L., Böhne S., The Paleocene fossil record of marine planktonic diatoms in deep-sea sediments; Renaudie J., Diver P., Lazarus D., New developments on the Neptune (NSB) database and associated softwares; Renaudie J., Gray, R., Lazarus D., Testing the accuracy of the MobileNet convolutional neural network to identify closely-related radiolarian species based on a sparse dataset.\\
...
\begin{longtable}{p{0.1\linewidth} P{0.85\linewidth}}
2015--18 & Organizer of the MfN `Code Clinic' Scientific Programming Club. \\
since 2013 & \href{http://publons.com/a/1291154/}{Reviews} for \textit{Proceedings of the Royal Society B}; \textit{Paleoceanography}; \textit{Paleobiology}; \textit{Palaeogeography, Palaeoclimatology, Palaeoecology}. \\
\end{longtable}

\section{WORKSHOP PARTICIPATIONS}
\begin{longtable}{p{0.1\linewidth} P{0.85\linewidth}}
%2018 & ecoClimate Hackathon at MfN.\\
