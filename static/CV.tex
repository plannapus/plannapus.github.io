...
\begin{longtable}{p{0.1\linewidth} P{0.85\linewidth}}
2019 & EGU general meeting in Vienna, Austria: convener of the session \href{https://meetingorganizer.copernicus.org/EGU2019/session/31040}{`Evolutionary development of plankton and its interaction with past, present and future geochemical cycles'} (co-conveners: Noble P., Lazarus D., Asatryan G. and Schobben M.).\\
\end{longtable}
\subsection{Talks}
\begin{longtable}{p{0.1\linewidth} P{0.85\linewidth}}
